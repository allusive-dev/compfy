...
DESCRIPTION
-----------
compfy is a compositor based on Picom based on Compton a fork of xcompmgr (which itself was written by Keith Packard). It includes improvements over Picom, like Animations and more rule sets.
